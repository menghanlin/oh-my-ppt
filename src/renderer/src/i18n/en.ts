...
- Do not create flickering or large-scale shaking animations`
  ...
  sessionDetail: {
    ...
    speechScriptTooltip: 'Generate a speaker script from slide content',
    speechScriptDialogTitle: 'Speech Script',
    speechScriptCopy: 'Copy',
    speechScriptCopied: 'Copied',
    speechScriptDownload: 'Download .md',
    speechScriptError: 'Failed to generate speech script, please try again',
